...
public class EgLogHandler extends EgActivity {
	...
	protected void initData() {
		...
		demoList.add(new Demo("说明", DemoDescImagesActivity.class)
				.setDrawable(new int[]{R.drawable.p_loghandler_1}));
		demoList.add(new Demo("Demo1:程序Crash测试", LogHandlerActivity.class));
