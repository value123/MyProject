...
public class EgWheelView extends EgActivity {
    ...
    protected void initData() {
        ...
        demoList.add(new Demo("说明", DemoDescImagesActivity.class)
                .setDrawable(new int[] { R.drawable.p_wheelview_1}));
        demoList.add(new Demo("Demo1:wheelview的使用", WheelViewActivity.class));
