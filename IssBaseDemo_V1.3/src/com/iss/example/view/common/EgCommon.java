...
public class EgCommon extends EgActivity {
	...
	protected void initData() {
		...
		demoList.add(new Demo("说明", DemoDescImagesActivity.class)
				.setDrawable(new int[]{R.drawable.p_common_1}));
		demoList.add(new Demo("Demo1:CustomScrollView&&MarqueeTextView", CustomScrollViewActivity.class));
