package com.iss.example.view.photoview;
...
public class EgPhotoView extends EgActivity {
	...
	protected void initData() {
		...
		demoList.add(new Demo("说明", DemoDescImagesActivity.class)
				.setDrawable(new int[]{R.drawable.p_photoview_1}));
		demoList.add(new Demo("Demo1:Simple Image", SimpleSampleActivity.class));
		demoList.add(new Demo("Demo1:ViewPager", ViewPagerActivity.class));
