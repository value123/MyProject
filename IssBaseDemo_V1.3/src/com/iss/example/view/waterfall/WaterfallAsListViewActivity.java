...
import com.iss.appdemo.adapter.WaterAsListViewAdapter;
...
public class WaterfallAsListViewActivity extends IssActivity {
    private PullToRefreshWaterView waterView;

    private WaterAsListViewAdapter waterAdapter;
    ...
    protected void initData() {
        waterAdapter = new WaterAsListViewAdapter(this);
        waterView.setAdapter(waterAdapter);
        waterAdapter.addItem(Images.imageUrls, true);
    }
    ...
    class GetPicTask extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            waterAdapter.addItem(Images.imageUrls, refresh);
        }
