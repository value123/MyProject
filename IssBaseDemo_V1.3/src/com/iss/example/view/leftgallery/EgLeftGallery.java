...
public class EgLeftGallery extends EgActivity {
	...
	protected void initData() {
		...
		demoList.add(new Demo("说明", DemoDescImagesActivity.class)
				.setDrawable(new int[]{R.drawable.p_leftgallery_1}));
		demoList.add(new Demo("Demo1:leftgallery", LeftGalleryActivity.class));
