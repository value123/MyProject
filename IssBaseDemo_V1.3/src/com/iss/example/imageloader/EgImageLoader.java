...
public class EgImageLoader extends EgActivity {
	...
	protected void initData() {
		...
		demoList.add(new Demo("说明", DemoDescImagesActivity.class)
				.setDrawable(new int[] { R.drawable.p_imageloader_1,
						R.drawable.p_imageloader_2, R.drawable.p_imageloader_3}));
		demoList.add(new Demo("Demo1:GridView加载图片", ImageGridActivity.class));
