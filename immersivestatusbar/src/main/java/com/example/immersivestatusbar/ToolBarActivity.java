    ...
    private void initToolBar() {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ToolBarActivity.this, "click navigation", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        navigationSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(ToolBarActivity.this, "you selected: " + category[position], Toast.LENGTH_SHORT).show();
        ...
        public boolean onMenuItemClick(MenuItem item) {
            switch (item.getItemId()) {
                case R.id.action_edit:
                    Toast.makeText(ToolBarActivity.this, "action_edit", Toast.LENGTH_SHORT).show();
                    break;
