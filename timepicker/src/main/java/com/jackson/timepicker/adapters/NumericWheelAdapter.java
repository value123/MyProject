...
//            if(isCurrentYearAndMonth && index==utils.get){
//                return "今天";
//            }else{
...
//            }
    ...
    public boolean isCurrentYearAndMonth = false;
    public void setIsCurrentYearAndMonth(boolean b){
        this.isCurrentYearAndMonth = b;
    }
}
